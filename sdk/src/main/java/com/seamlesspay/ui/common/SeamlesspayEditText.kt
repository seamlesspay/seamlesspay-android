 ...
 */
open class SeamlesspayEditText @JvmOverloads constructor(
    context: Context,
    ...
    /**
     * Sets the error text color on this [SeamlesspayEditText].
     *
    ...
    private fun determineDefaultErrorColor() {
        ...
        defaultErrorColor = ContextCompat.getColor(
            context,
            if (SeamlesspayColorUtils.isColorDark(textColors.defaultColor)) {
                // Note: if the _text_ color is dark, then this is a
                // light theme, and vice-versa.
                R.color.seamlesspay_error_text_light_theme
            } else {
                R.color.seamlesspay_error_text_dark_theme
            }
        )
    }
