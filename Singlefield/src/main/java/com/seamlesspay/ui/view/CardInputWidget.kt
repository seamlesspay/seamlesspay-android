...
class CardInputWidget @JvmOverloads constructor(
    ...
    @VisibleForTesting
    @JvmSynthetic
    internal val standardFields: List<SeamlesspayEditText>

    @VisibleForTesting
    internal val allFields: List<SeamlesspayEditText>
        @JvmSynthetic
        get() {
    ...
    val expirationMonth: String?
        get() {
            ...
            if (cardDate != null) {
                val em =  cardDate.first
                if (em < 10) {
                    return "0" + em.toString()
                } else {
                    return em.toString()
                }
            }
    ...
    val expirationYear: String?
        get() {
            val cardDate = expiryDateEditText.validDateFields
            if (cardDate != null) {
                return cardDate.second.toString()
            }
            return null;
        }
    ...
    init {
        ...
        minimumWidth = resources.getDimensionPixelSize(R.dimen.seamlesspay_card_widget_min_width)
     ...
     * @return a [SeamlesspayEditText] that needs to request focus, or `null`
    ...
    private fun getDesiredWidthInPixels(text: String, editText: SeamlesspayEditText): Int {
    ...
    private fun initView(attrs: AttributeSet?) {
        ...
        cvcNumberEditText.setAfterTextChangedListener(
            object : SeamlesspayEditText.AfterTextChangedListener {
    ...
    internal companion object {
        ...
        @IdRes
        private val DEFAULT_READER_ID = R.id.seamlesspay_default_reader_id
