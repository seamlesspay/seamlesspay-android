...
public class InitialValueCheckBox extends AppCompatCheckBox {
  private static final String EXTRA_SUPER_STATE =
    "InitialValueCheckBox.EXTRA_SUPER_STATE";
  private static final String EXTRA_CHECKED_VALUE =
    "InitialValueCheckBox.EXTRA_CHECKED_VALUE";
