 ...
 */
public class ExpirationDateEditText
   ...
   */
  public void useDialogForExpirationDateEntry(
    Activity activity,
    boolean useDialog
  ) {
    ...
    if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
      ...
      try {
        ...
        try {
          // API 15
          final Method method =
            EditText.class.getMethod("setSoftInputShownOnFocus", boolean.class);
