...
public class CvvEditText extends ErrorEditText implements TextWatcher {
  ...
  public void setCardType(CardType cardType) {
    ...
    InputFilter[] filters = {
      new LengthFilter(cardType.getSecurityCodeLength())
    };
  ...
  public void afterTextChanged(Editable editable) {
    ...
    if (
      mCardType.getSecurityCodeLength() == editable.length() &&
  ...
  public boolean isValid() {
    return (
      isOptional() || getText().toString().length() == getSecurityCodeLength()
    );
  }
