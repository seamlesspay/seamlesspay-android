...
public class Authorization implements Parcelable {
    ...
    Authorization(String environmentString, String authorizationKeyString, @Nullable String authorizationApiKeyString)
        ...
        mAuthorizationApiKey = new String(Base64.encodeToString(authorizationApiKeyString.getBytes(), Base64.NO_WRAP));
        mAuthorizationKey = new String(Base64.encodeToString(authorizationKeyString.getBytes(), Base64.NO_WRAP));
    ...
    public static Authorization fromKeys(String environmentString, String authorizationKeyString)
            throws InvalidArgumentException {
        return  Authorization.fromKeys(environmentString, authorizationKeyString, null);
    }

    public static Authorization fromKeys(String environmentString, String authorizationKeyString, @Nullable String authorizationApiKeyString)
            throws InvalidArgumentException {

        if (TextUtils.isEmpty(authorizationApiKeyString) || authorizationApiKeyString == null){
            authorizationApiKeyString = authorizationKeyString;
        }
        return new Authorization(environmentString, authorizationKeyString, authorizationApiKeyString);
    }
