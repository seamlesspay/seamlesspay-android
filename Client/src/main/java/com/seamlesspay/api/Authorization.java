...
public class Authorization implements Parcelable {
    ...
    Authorization(String environmentString, String authorizationKeyString, String authorizationApiKeyString)
    ...
    public static Authorization fromKeys(String environmentString, String authorizationKeyString, String authorizationApiKeyString)
            throws InvalidArgumentException {
