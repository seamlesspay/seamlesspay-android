...
public class SeamlesspayFragment extends BrowserSwitchFragment {
    ...
    /**
     * Create a new instance of SeamlesspayFragment using the authorization key or client token and add it to the
     * AppCompatActivity's FragmentManager. If a fragment has already been created with the provided
    ...
    /**
     * Create a new instance of SeamlesspayFragment using the tokenization key or client token and add it to the
     * Fragment's child  FragmentManager. If a fragment has already been created with the provided
     * authorization, the existing fragment will be returned.
     *
