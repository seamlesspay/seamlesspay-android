...
public abstract class BaseChargeBuilder<T> implements Parcelable {
    ...
    protected static final String ORDERID_KEY = "orderID";
    ...
    protected static final String CREDENTIAL_INDICATOR_KEY = "credentialIndicator";
    ...
    public String build() {
        ...
        try {
            ...
            if (mSurchargeFeeAmount != null) {
                base.put(SURCHARGE_FEEAMOUNT_KEY, mSurchargeFeeAmount);
            }

            if (mOrderID != null) {
                base.put(ORDERID_KEY, mOrderID);
            }
