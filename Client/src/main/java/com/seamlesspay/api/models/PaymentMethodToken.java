...
public abstract class PaymentMethodToken implements Parcelable {
    ...
    public static PaymentMethodToken parsePaymentMethodToken(String json, String type) throws JSONException {
    ...
    public static PaymentMethodToken parsePaymentMethodToken(JSONObject json, String type) throws JSONException {
        switch (type) {
